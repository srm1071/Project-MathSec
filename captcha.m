...
% Last Modified by GUIDE v2.5 04-Apr-2018 20:41:32
...
l=strcmp(x,value);
if l==1
    msgbox('Registration Successful, Welcome Sir / Mam !','Successful');
    set(handles.edit1,'String','');
else
    msgbox('Please fill the CAPTCHA correctly','Sorry');
    set(handles.edit1,'String','');
end
